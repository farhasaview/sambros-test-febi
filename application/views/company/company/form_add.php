...
<form action="<?=base_url()?>company/addCompany" method="post" enctype="multipart/form-data" data-toggle="validator">
  ...
  <div class="form-group">
    ...
    <input type="file" accept=".jpg,.jpeg,.png" id="image-source" name="logo" onchange="previewImage();" class="form-control-file" required>
